         ...
         <div class="col-md-6 col-sm-12 mb-20">
          <div class="onjob-employer-resumes-wrap">
            ...
            <ul class="onjob-resumes-options">
              ...
              <li><a href="#" data-toggle="modal" data-id="<?= $applicant['id']; ?>" data-target="#emailModal" data-feedback="<?= $applicant['feedback']; ?>" data-whatever="<?= $applicant['email']; ?>"><i class="lnr lnr-envelope"></i> <?=trans('feedback')?></a></li>
            </ul>
          </div>
        </div>
      <?php endforeach; ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open("/employers/feedback",'class="email-form"') ?>
